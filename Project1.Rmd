...
### To achieve a consistent result, 1000 is used as the pseudorandom seed. The caret and random Forest packages are needed to build the model.

### set env, read in data set and set pseudorandom seed to 1000
```{r}
setwd("C:/Assignment")
...
## Model 2 - using the random Forest function
```{r results='hide'}
